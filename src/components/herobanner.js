...
const HeroBanner = () => {
  return (
    <Box sx={{ mt: { lg: '212px', xs: '70px'}, ml: {sm: '50px'}}} position="relative" p="20">
        <Typography color="#FF2625" fontWeight="600" fontSize="26px">San Isidro Gyms</Typography>
        <Typography fontWeight={700} sx={{ fontSize: {lg: '44px', xs: '40px'}}} mb='23px' mt='30px'>Sweat, Smile <br /> and Repeat</Typography>
        <Typography fontSize="22px" fontFamily={"Alegreya"} lineHeight="35px" mb={4}>Check out the most effective exercises</Typography>
